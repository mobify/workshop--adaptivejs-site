...
define('adaptivejs/utils/general',[
    'buildConfig'
...
define('adaptivejs/utils/buildScript',['adaptivejs/utils/general'], function(adaptiveUtils) {
    /**
...
define('adaptivejs/utils/isDebug',[],function() {

    /**
     *  If the mobify-path cookie is present, then we are in debug mode
     */
    var isDebug = function(cookie) {
...
define('adaptivejs/utils',[
    'mobifyjs/utils',
    'adaptivejs/utils/general',
    'adaptivejs/utils/assets',
    'adaptivejs/utils/buildScript',
    'adaptivejs/utils/buildOrigin',
    'adaptivejs/utils/isCapturing',
    'adaptivejs/utils/isDebug',
    'adaptivejs/utils/isLocal',
], function(mobifyJsUtils, generalUtils, assetUtils, buildScript, buildOrigin, isCapturing, isDebug, isLocal) {

    var AdaptiveUtils = {};

    mobifyJsUtils.extend(AdaptiveUtils, mobifyJsUtils, generalUtils, assetUtils, {
        getBuildScript: buildScript,
        getBuildOrigin: buildOrigin,
...
define("json!package", function(){ return {
    "name": "merlins-potions-adaptive-2",
    "repository": {
        "type": "git",
    ...
    "dependencies": {
        ...
        "mocha": "~1.14.0",
        "chai": "~1.9.0",
        "mobify-chai-assertions": "^1.1.0",
        "lodash": "~2.4.1",
        "grunt-contrib-sass": "0.8.1",
        "grunt-autoprefixer": "2.0.0",
        "nightwatch": "~0.6.11",
        "nightwatch-commands": "~1.1.0",
        "grunt-eslint": "^13.0.0",
        "mobify-code-style": "^2.1.0"
}
}
;});
...
define('global/includes/header/context',['$'], function($) {
    return {
        context: {
            title: function() {
                var $title = $('title');
...
define('global/includes/footer/context',['$'], function($) {
    return {
        context: {
            documentationLink: function() {
                return {
                    text: 'Adaptive.js Documentation',
                    href: 'http://adaptivejs.mobify.com/'
                };
            }
        }
    };
...
define('dust!pages/home/template',["dust-custom","dust!global/base"],function(dust){(function(){dust.register("pages/home/template",body_0);var blocks={"contentBlock":body_1,"uiScripts":body_2};function body_0(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.partial("global/base",ctx,null).write("\n\n").write("\n\n").write("\n\n");}function body_1(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n    ").write("<p>We've also extracted the first paragraph from your site and placed it in the homepage template:</p>").write("\n\n    ").write("<p class=\"c-card\">").write("\n        ").reference(ctx._get(false, ["firstp"]),ctx,"h").write("\n    ").write("</p>").write("\n");}function body_2(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n    ").write("<script>").write("\n    ").write("// Note: Add any JavaScript that should be run on this page into").write("\n    ").write("// app/pages/home/ui.js").write("\n    ").write("(function(require) {").write("\n        ").write("require([\"global/ui\", \"pages/home/ui\"], function(globalUI, homeUI) {").write("\n            ").write("globalUI();").write("\n            ").write("homeUI();").write("\n        ").write("});").write("\n    ").write("})(Adaptive.AMD.require);").write("\n    ").write("</script>").write("\n");}return body_0;})(); return function(context, callback) {return dust.render("pages/home/template", context, callback)}});
/**
 * Home View
 */

define('pages/home/view',[
    '$',
    'global/baseView',
...
define('adaptivejs/adaptive',[
    ...
    'adaptivejs/logger',
    'adaptivejs/utils'
], function($, Defaults, Logger, Utils) {
    ...
    */
    Adaptive.restore = function(block) {
        ...
        Adaptive.capture.restore(ajsScript + (block || ''));
        ...
        if (Utils.isCapturing()) {
            ...
            var initCapture = function() {
                if (window.Capture) {
                    ...
                    window.Capture.init(function(capture) {
