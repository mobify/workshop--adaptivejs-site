...
define('buildConfig',[], function() {
    return {
        buildDate: 1434660164541,
        cacheHashManifest: {"css/stylesheet.css":"13a0f96d","css/stylesheet.css.map":"067759e5","images/cauldron.png":"bb5a5e0d","images/logo.png":"3e527358","images/menu.png":"7e2824f7","js/ui.js":"7369a886","js/ui.js.map":"faa43114","bower_components/deckard/dist/deckard.min.js":"8b1854e7"}
    }
});
...
define("json!package", function(){ return {
    ...
    "dependencies": {
        ...
        "nightwatch": "0.5.6",
        "nightwatch-commands": "0.0.11",
        "grunt-contrib-jshint": "0.10.0",
        "jshint": "2.5.0",
        "grunt-jscs": "^0.7.1",
        "mobify-code-style": "1.0.0"
}
}
;});
...
define('dust!templates/partials/_header',["dust-custom"],function(dust){(function(){dust.register("templates/partials/_header",body_0);function body_0(chk,ctx){return chk.section(ctx._get(false, ["header"]),ctx,{"block":body_1},null).write("\n");}function body_1(chk,ctx){return chk.write("\n    ").write("<header class=\"t-header\" role=\"banner\">").write("\n        ").write("<div class=\"t-header__menu\">").write("\n            ").write("<a class=\"c-button c--brand js-header-menu__link\"></a>").write("\n        ").write("</div>").write("\n\n        ").write("<div class=\"t-header__logo\">").write("\n            ").write("<a href=\"").reference(ctx._get(false, ["logoHref"]),ctx,"h").write("\">").write("\n                ").write("<img src=\"").helper("getUrl",ctx,{},{"path":"images/logo.png"}).write("\" alt=\"Merlins Potions\">").write("\n            ").write("</a>").write("\n        ").write("</div>").write("\n\n        ").write("<div class=\"t-header__cart\">").write("\n            ").write("<div class=\"c-cart-count\">").write("\n                ").write("<div class=\"c-cart-count__text\">").write("\n                    ").write("<span class=\"c-cart-count__number\">").reference(ctx._get(false, ["cartCount"]),ctx,"h").write("</span>").write("\n                ").write("</div>").write("\n            ").write("</div>").write("\n        ").write("</div>").write("\n    ").write("</header>").write("\n");}return body_0;})(); return function(context, callback) {return dust.render("templates/partials/_header", context, callback)}});

define('dust!templates/partials/_footer',["dust-custom"],function(dust){(function(){dust.register("templates/partials/_footer",body_0);function body_0(chk,ctx){return chk.section(ctx._get(false, ["footer"]),ctx,{"block":body_1},null).write("\n");}function body_1(chk,ctx){return chk.write("\n    ").write("<footer class=\"t-footer\" role=\"contentinfo\">").write("\n        ").write("<div class=\"t-footer__form\">").write("\n            ").reference(ctx._get(false, ["newsletter"]),ctx,"h").write("\n        ").write("</div>").write("\n        ").write("<div class=\"t-footer__fineprint\">").write("\n            ").reference(ctx._get(false, ["copyright"]),ctx,"h").write("\n        ").write("</div>").write("\n    ").write("</footer>").write("\n");}return body_0;})(); return function(context, callback) {return dust.render("templates/partials/_footer", context, callback)}});
...
define('dust!templates/home',["dust-custom","dust!templates/base"],function(dust){(function(){dust.register("templates/home",body_0);var blocks={"contentBlock":body_1,"uiScripts":body_5};function body_0(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.partial("templates/base",ctx,null).write("\n\n").write("\n\n").write("\n\n");}function body_1(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n    ").reference(ctx._get(false, ["hero"]),ctx,"h").write("\n\n    ").write("<div class=\"c-shipping-banner\">").write("\n        ").reference(ctx._get(false, ["shipping"]),ctx,"h").write("\n    ").write("</div>").write("\n\n    ").write("<div class=\"t-home__promo\">").write("\n        ").reference(ctx._get(false, ["discountBanner"]),ctx,"h").write("\n    ").write("</div>").write("\n\n    ").write("<div class=\"t-home__content\">").write("\n        ").write("<div class=\"c-tab\">").write("\n            ").write("<div class=\"c-tab__controls\">").write("\n                ").section(ctx._get(false, ["categories"]),ctx,{"block":body_2},null).write("\n            ").write("</div>").write("\n\n            ").section(ctx._get(false, ["categories"]),ctx,{"block":body_3},null).write("\n        ").write("</div>").write("\n    ").write("</div>").write("\n\n");}function body_2(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n                    ").write("<button class=\"c-tab__button u-unstyle js-tabs__header\">").reference(ctx._get(false, ["title"]),ctx,"h").write("</button>").write("\n                ");}function body_3(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n                ").write("<div class=\"c-tab__section c-product-list js-tabs__sections\">").write("\n                    ").section(ctx._get(false, ["products"]),ctx,{"block":body_4},null).write("\n                ").write("</div>").write("\n            ");}function body_4(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n                        ").write("<a href=\"").reference(ctx._get(false, ["href"]),ctx,"h").write("\" class=\"c-product-list__item\">").write("\n                            ").reference(ctx._get(false, ["image"]),ctx,"h").write("\n                            ").write("<div class=\"c-tab__description\">").reference(ctx._get(false, ["title"]),ctx,"h").write("</div>").write("\n                            ").write("<div class=\"c-price\">").reference(ctx._get(false, ["price"]),ctx,"h").write("</div>").write("\n                        ").write("</a>").write("\n                    ");}function body_5(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n    ").write("<script>").write("\n    ").write("// Note: Add any JavaScript that should be run on this page into").write("\n    ").write("// assets/js/ui/view-scripts/home.js").write("\n    ").write("(function(require) {").write("\n        ").write("require([\"view-scripts/home\"], function(homeUI) {").write("\n            ").write("homeUI();").write("\n        ").write("});").write("\n    ").write("})(Adaptive.AMD.require);").write("\n    ").write("</script>").write("\n");}return body_0;})(); return function(context, callback) {return dust.render("templates/home", context, callback)}});
define('views/home',[
    '$',
    'views/base',
    'dust!templates/home'
...
define('dust!templates/category',["dust-custom","dust!templates/base"],function(dust){(function(){dust.register("templates/category",body_0);var blocks={"contentBlock":body_1,"uiScripts":body_2};function body_0(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.partial("templates/base",ctx,null).write("\n\n").write("\n\n").write("\n\n");}function body_1(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n    ").write("<div class=\"t-category__title\">").write("\n        ").reference(ctx._get(false, ["title"]),ctx,"h").write("\n    ").write("</div>").write("\n    ").reference(ctx._get(false, ["listing"]),ctx,"h").write("\n");}function body_2(chk,ctx){ctx=ctx.shiftBlocks(blocks);return chk.write("\n    ").write("<script>").write("\n    ").write("// Note: Add any JavaScript that should be run on this page into").write("\n    ").write("// assets/js/ui/view-scripts/category.js").write("\n    ").write("(function(require) {").write("\n        ").write("require([\"view-scripts/category\"], function(categoryUI) {").write("\n            ").write("categoryUI();").write("\n        ").write("});").write("\n    ").write("})(Adaptive.AMD.require);").write("\n    ").write("</script>").write("\n");}return body_0;})(); return function(context, callback) {return dust.render("templates/category", context, callback)}});
